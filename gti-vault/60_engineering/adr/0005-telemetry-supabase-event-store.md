...
[[../../50_product/north-star|north-star.md]] names **% of verdicts followed-through** as the primary metric. The v1 "definition of done" in [[../../50_product/v1-scope|v1-scope]] requires that metric be computable across the beta cohort. Without telemetry, the thesis test is unobservable.
...
- **Supabase tables + SQL views** — already in stack; SQL queries answer the v1 questions.
- **Defer** — rejected; violates v1 DoD.
...
2. **Privacy posture stays clean.** [[0006-privacy-posture-v1|ADR 0006]] enforces a strict no-third-party-PII rule; PostHog/Mixpanel would re-open that decision.
3. **SQL answers v1 questions directly.** The metrics we need are aggregates and joins — Supabase's native shape.
...
- [[../../50_product/v1-scope|v1-scope.md]] §Definition of done
