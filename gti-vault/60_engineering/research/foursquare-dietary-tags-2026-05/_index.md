...
purpose: Verify Foursquare Places API dietary-tag coverage for the v1 Q1 menu-compliance filter
prd: v1-prd
adr: 0002
...
Audit of Foursquare Places API for the dietary tags the v1 Q1 mechanic requires. The Q1 lock ([[../../../50_product/v1-design-locks|v1-design-locks.md]] Lock 1) treats Q1 as a **menu-compliance filter** — restaurants must *offer* compliant options, not exclusively be of that type. This needs the API to expose per-restaurant dietary signals.
...
- [ ] **Live coverage probes against beta metro** — blocked on Foursquare API key (see [[../../../15_issues/v1/issues/tb-00-external-accounts|TB-00]]). Per-tag `coverage_estimate_pct` fields stay `unverified` until that lands.
...
- [[../../../50_product/v1-design-locks|v1-design-locks]] — Lock 1 (Q1 mechanic).
- [[../../../15_issues/v1/issues/05-foursquare-dietary-tags|Issue 05]] — issue this bundle closes.
- [[../../../15_issues/v1/issues/tb-05-foursquare-placesproxy|TB-05]] — PlacesProxy tracer bullet that consumes this finding.
