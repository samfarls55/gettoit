...
- [[v1-scope]] — Smallest cut that proves the thesis: food vertical only, no ML. Deferrals + open gaps.
- [[research-brief]] — Decision-simplification research questions. **CLOSED 2026-05-08**; see deliverables below.
- [[framework-comparison]] — P1 synthesis. Locks the v1 engine as EBA + Satisficing hybrid; assigns sub-signal roles to remaining frameworks.
