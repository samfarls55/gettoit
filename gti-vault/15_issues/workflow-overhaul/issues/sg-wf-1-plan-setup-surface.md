...
[[../../../50_product/workflow-overhaul-plan-setup|workflow-overhaul-plan-setup]] — the locked decisions from the 2026-05-19 `/grill-with-docs` session. This issue lands the design-system contract for the new Setup surface that collapses today's S01 + S01b into a single screen.
...
**Removed from the merged S01 + S01b inventory:** Category picker (food only in v1, no picker rendered), Timer chip group (retired by v1.1 PRD US34/US35/§115), Transport mode chips (collapsed into the distance slider).
