...
- **Member-local cuisine selection.** `selectProbedCuisines` ranks the
  ...
  (v1.1-quiz-amendments §"Q1 multi-select and the cuisine cap"). The
...
- **Q5 framing copy.** The v1 `QuizQ5Regret` view carried the v1
  "regret" wording ("how much would you mind?", "DON'T MIND" / "REALLY
  MIND"). The v1.1 PRD and the surface spec fix Q5 as an *excitement*
  ...
  its v1 sample copy — illustrative, not locked (see the surface doc's
