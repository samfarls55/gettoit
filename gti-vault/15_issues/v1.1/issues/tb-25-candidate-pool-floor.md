...
[[../../../60_engineering/adr/0012-candidate-pool-floor|ADR 0012 — Candidate-pool floor]]. Amends [[../../../50_product/v1.1-quiz-amendments|v1.1-quiz-amendments]] §5. Closes the un-floored general-call leak found in an undocumented diagnosis session and ratified in the 2026-05-19 `/grill-with-docs` session.
