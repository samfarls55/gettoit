...
| bug-09 | [[issues/bug-09-verdict-fire-dispatch-guc-noop\|Verdict engine never auto-invoked — dispatch no-ops on unset app.* DB GUCs]] 🟢 ready-for-agent — re-scoped 2026-05-18 (Option 2): `app.*` GUCs abandoned (need superuser), `dispatch_compute_verdict` reads an `app_config` table instead | AFK | [#117](https://github.com/samfarls55/gettoit/issues/117) | — |
