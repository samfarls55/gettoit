---
folder: 15_issues/vibe-embeddings-scoring
purpose: Vibe embeddings scoring PRD and issue-tracker context
---

# Vibe Embeddings Scoring - Index

Implement transient backend embeddings for **Vibe fit signal** generation so Q5 and final verdict scoring can map Google-derived atmosphere evidence onto the Quiet-to-Rowdy **Vibe band** while preserving ADR 0022's Google Places retention boundary.
...
- [[../../60_engineering/adr/0023-transient-vibe-embeddings-in-scoring|ADR 0023 - Vibe embeddings run transiently in recommendation scoring]]
- [[../../../CONTEXT|CONTEXT]]
