...
The 0.1.0 PRD ([[../../../10_prds/0.1.0-prd|0.1.0-prd.md]]) locks the late-joiner behavior: a user who taps the invite link AFTER the verdict ships sees the verdict on a read-only surface with a re-invite CTA below. They cannot retroactively influence the closed decision.
