...
The Plan list grill ([[../../../50_product/0.1.0-workflow-overhaul-plan-list|0.1.0-workflow-overhaul-plan-list]] §Q5) lifted the `Who's coming` choice out of Setup into a pre-Setup disambig sheet attached to the create-Plan affordance. Setup screen now renders **conditionally on a `mode: .solo | .group` parameter** passed in at construction:
