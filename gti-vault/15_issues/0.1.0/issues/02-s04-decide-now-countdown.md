...
The 0.1.0 PRD ([[../../../10_prds/0.1.0-prd|0.1.0-prd.md]]) locks the verdict fire to **initiator-set timer OR initiator tap on the Waiting surface**, with a minimum quorum of 2 answers. The current `design-system/surfaces/04-waiting.md` explicitly reserves the "initiator force-verdict" affordance for v2 (line 39). This issue brings it into 0.1.0.
