...
The cuisine likes/dislikes profile editor is **deferred** to the pre-public-launch milestone (see [[../_index#0.1.0 → pre-public-launch milestone handoff]] and [[../../../50_product/questions-profile-vs-session-split|the profile/session decision]]). This issue scopes only to (1) and (2) above.
...
- **Edit existing waiting-surface spec** in `design-system/surfaces/` (the waiting / quorum surface — likely S04 per [[../../../10_prds/0.1.0-prd|0.1.0 PRD]]). Add:
