...
[[sg-wf-4-plan-list-surface|sg-WF-4]] — design-system spec for the Plan list surface. Locked decisions in [[../../../50_product/0.1.0-workflow-overhaul-plan-list|0.1.0-workflow-overhaul-plan-list]] §Q4 (delete affordance + confirm sheet copy).
...
- **Secondary swipe-to-delete with sun-yellow desaturated reveal.** Deferred per the grill doc — keep one-affordance for 0.1.0; revisit only if testing surfaces real complaint about gesture-discovery.
