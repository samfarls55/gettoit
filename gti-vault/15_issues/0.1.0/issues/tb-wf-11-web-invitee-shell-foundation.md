...
[[sg-wf-5-web-invitee-flow|sg-WF-5]] — the web invitee shell design-system surface doc. Behavior locked in [[../../../50_product/0.1.0-workflow-overhaul-web-invitee-flow|0.1.0-workflow-overhaul-web-invitee-flow]] §Q3 (identity) and §Q4 (name entry).
...
- The redesigned quiz screens themselves — [[tb-wf-10-web-quiz-v11-port|tb-WF-10]]. The scaffold hands off to whatever quiz currently renders; tb-WF-10 swaps it to the redesigned quiz.
