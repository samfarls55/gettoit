...
- [x] iOS app builds on iOS 17 simulator, signs in anonymously, displays `user_id` on launch. _(2026-05-13 — iOS 17.5 sim under Xcode 16.2 on macOS-14 runner)_
- [x] Integration test for anon auth passes. _(2026-05-13)_
- [x] CI workflow runs all four lanes green. _(2026-05-13 — PR #24)_
