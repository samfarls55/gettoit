...
[[../../../10_prds/0.1.0-quiz-redesign-prd|0.1.0 Quiz Redesign & Verdict Engine PRD]] — module (K). Covers the *parameters* bucket of the three-bucket input model.
...
- **Geography** — where the group is meeting (location already exists via the 0.1.0 LocationPicker; reuse it).
