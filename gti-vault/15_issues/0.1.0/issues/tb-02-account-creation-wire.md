...
- CTA opens the App Store URL (use the GetToIt App Store URL once available; for 0.1.0 a placeholder URL is acceptable if Apple ingest is still pending — flag in a follow-up).
