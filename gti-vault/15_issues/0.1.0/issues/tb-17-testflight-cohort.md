...
The final HITL slice — get a real beta cohort running so the north-star metric can be measured. Per [[../../../50_product/0.1.0-scope|0.1.0-scope]] the cohort is 3–5 friend groups of 3–6 members in a single metro, hand-picked from the founder's own social network.
