...
[[../../../50_product/0.1.0-workflow-overhaul-plan-setup|0.1.0-workflow-overhaul-plan-setup]] §Q3 — the Plan list becomes the new app landing surface, replacing S00 Landing. The *what* was locked in the 2026-05-19 grill; the *how* (card visuals, status badges, ordering, empty state, history visibility) was deferred to a follow-up grill.
...
A design-system surface doc + JSX for the Plan list, implementing every locked decision in [[../../../50_product/0.1.0-workflow-overhaul-plan-list|0.1.0-workflow-overhaul-plan-list]] §Q1–Q8. The decisions doc is the canonical source; this section summarizes the build contract for AFK pickup.
...
- [x] A grill session resolves the open items and produces a locked-decisions doc → [[../../../50_product/0.1.0-workflow-overhaul-plan-list|0.1.0-workflow-overhaul-plan-list]] (2026-05-20).
...
Side amendments to parent grill captured inline in [[../../../50_product/0.1.0-workflow-overhaul-plan-setup|0.1.0-workflow-overhaul-plan-setup]]: §Q7 (lifted solo/group out) and §Q11 (Created-only tap rule).
