...
[[../../../10_prds/0.1.0-quiz-redesign-prd|0.1.0 Quiz Redesign & Verdict Engine PRD]] — modules (D) fetch planner + (F) fetch executor. The real, at-scale closure of [[bug-03-q5-placeholder-no-foursquare-calls|bug-03]]'s silent no-call failure mode.
