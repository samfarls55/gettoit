...
| bug-33 | [[issues/bug-33-locationcoordinator-dispatchqueue-mainactor\|Swap `DispatchQueue.main.async` for `Task { @MainActor in ... }` in `LocationCoordinator` (CONC-010)]] | done (bug) — PR #246 | AFK | [#242](https://github.com/samfarls55/gettoit/issues/242) | — |
