...
purpose: 0.1.0 PRD phase (formerly the "v1" batch) — tracer-bullet build slices + design-system spec-gap issues
---

# 0.1.0 PRD phase — Implementation Issues

> Previously labeled the `v1` batch. Renamed 2026-05-25 — `v1` is now reserved for the first public-launch release.
...
| TB-10 | [[issues/tb-10-reroll\|Reroll sheet + 3-cap + reason-to-constraint]] ✅ done | AFK | [#11](https://github.com/samfarls55/gettoit/issues/11) | TB-08 |
| TB-11 | [[issues/tb-11-late-joiner-read-only\|Late-joiner read-only verdict]] ✅ done | AFK | [#12](https://github.com/samfarls55/gettoit/issues/12) | TB-08 |
...
| TB-17 | [[issues/tb-17-testflight-cohort\|TestFlight external + cohort 1 recruit]] ⏸ deferred — AFK scaffolding (CI archive + upload) done; HITL setup + cohort recruitment parked until founder comfortable in app + dogfood-phase TBs/bugs cleared | HITL+AFK | [#18](https://github.com/samfarls55/gettoit/issues/18) | TB-16 |
...
- [[../../10_prds/0.1.0-prd|0.1.0 PRD]] — canonical product requirements
- [[../../50_product/0.1.0-design-locks|0.1.0-design-locks]] — research deliverables and PRD-grill resolutions
- [[../../50_product/0.1.0-scope|0.1.0-scope]] — what ships, what defers
