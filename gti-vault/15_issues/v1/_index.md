...
| TB-17 | [[issues/tb-17-testflight-cohort\|TestFlight external + cohort 1 recruit]] ⏸ deferred — AFK scaffolding (CI archive + upload) done; HITL setup + cohort recruitment parked until founder comfortable in app + v1.1 TBs/bugs cleared | HITL+AFK | [#18](https://github.com/samfarls55/gettoit/issues/18) | TB-16 |
