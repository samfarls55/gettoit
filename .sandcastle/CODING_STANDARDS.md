...
- Follow `.editorconfig`: UTF-8, LF, spaces, final newline; Python/shell use 4-space indent, others 2-space.
...
- Never expose service-role keys or privileged secrets to browser/mobile clients.
...
- Do not duplicate domain rules across mobile/web/Edge; reuse shared modules, generated outputs, or explicit mappers.
