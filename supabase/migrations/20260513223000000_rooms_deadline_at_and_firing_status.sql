...
-- TB-07 â€” rooms.deadline_at + 'firing' status + wider members SELECT.
--
-- Three coupled changes that TB-07 needs before any RPC / trigger /
-- cron can land:
--
--   1. `rooms.deadline_at` â€” computed timestamp at row creation as
...
--      columns must be `IMMUTABLE` â€” `now()` and `interval` arithmetic
...
--     regress visibility â€” it narrows back.

-- â”€â”€ 1. rooms.deadline_at column + insert trigger â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ 2. rooms.status widening â€” accept 'firing' â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
comment on column public.rooms.status is
    'Room lifecycle. open â†’ firing â†’ verdict_ready â†’ locked, with expired as the terminal when the timer ran out below quorum. firing is set by the manual-fire RPC OR the pg_cron auto-fire path; verdict_ready by the VerdictEngine after writing the verdict row.';

-- â”€â”€ 3. is_room_member helper + wider members SELECT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- Wider members SELECT â€” any authenticated user can read members of
...
-- them). Postgres OR's the two policies â€” broader visibility wins
